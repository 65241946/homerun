        ...
        config_schema={
            "param_fields": [
                ...
                {"key": "lookback_seconds", "label": "Lookback (seconds)", "type": "number", "min": 60, "phase": "signal"},
                {
                    ...
                    "label": "Breakout Threshold (price)",
                    "type": "number",
                    "min": 0.02,
                    "max": 0.5,
                    "phase": "signal",
                    "description": "Absolute compatibility fallback used only when the relative threshold is disabled.",
                },
                {
                    "key": "breakout_threshold_rel",
                    "label": "Breakout Threshold (relative)",
                    "type": "number",
                    "min": 0,
                    "max": 5,
                    "phase": "signal",
                    "description": "Primary rise/baseline gate; set to 0 to use the absolute fallback.",
                },
                ...
                {
                    "key": "stall_giveback_fraction",
                    "label": "Stall Giveback Fraction",
                    "type": "number",
                    "min": 0,
                    "max": 1,
                    "description": "Close after the stall window once this share of peak profit is given back.",
                },
            ]
        },
    ),
    ...
    SystemOpportunityStrategySeed(
        ...
        config_schema={
            "param_fields": [
                ...
                {"key": "min_confidence", "label": "Min Confidence", "type": "number", "min": 0, "max": 1},
                {"key": "maker_quote_min_spread", "label": "Maker minimum spread", "type": "number", "default": 0.01, "min": 0, "max": 1},
                {"key": "maker_quote_min_liquidity", "label": "Maker minimum liquidity", "type": "number", "default": 200.0, "min": 0},
                {"key": "maker_quote_min_seconds_left", "label": "Maker minimum seconds left", "type": "number", "default": 30.0, "min": 0},
                {"key": "maker_quote_base_score", "label": "Maker base score", "type": "number", "default": 25.0, "min": 0},
                {"key": "maker_quote_spread_score_scale", "label": "Maker spread score scale", "type": "number", "default": 400.0, "min": 0},
                {"key": "maker_quote_max_score", "label": "Maker maximum score", "type": "number", "default": 90.0, "min": 0},
                {"key": "maker_quote_thin_book_usd", "label": "Maker thin-book threshold USD", "type": "number", "default": 1000.0, "min": 0},
                {"key": "maker_quote_thin_book_bonus", "label": "Maker thin-book score bonus", "type": "number", "default": 15.0, "min": 0},
                {"key": "maker_quote_min_size_usd", "label": "Maker minimum leg size USD", "type": "number", "default": 5.0, "min": 0},
                {"key": "maker_quote_max_size_usd", "label": "Maker maximum leg size USD", "type": "number", "default": 25.0, "min": 0},
                {"key": "maker_quote_resolution_risk_seconds", "label": "Maker resolution-risk seconds", "type": "number", "default": 45.0, "min": 0},
                {"key": "maker_quote_skew_max", "label": "Maker maximum oracle skew", "type": "number", "default": 0.03, "min": 0},
                {"key": "maker_quote_skew_scale", "label": "Maker oracle skew scale (%)", "type": "number", "default": 1.0, "min": 0.001},
                {"key": "maker_min_combined_edge", "label": "Maker minimum combined edge", "type": "number", "default": 0.015, "min": 0, "max": 1},
                {"key": "maker_quote_leg_fill_tolerance_ratio", "label": "Maker leg fill tolerance ratio", "type": "number", "default": 0.02, "min": 0, "max": 1},
                {"key": "maker_session_timeout_seconds", "label": "Maker session timeout seconds", "type": "number", "default": 300.0, "min": 1},
                {"key": "hedge_timeout_by_timeframe", "label": "Hedge timeout by timeframe", "type": "object", "default": {"5m": 5, "15m": 10, "1h": 20, "4h": 30}},
                {"key": "reentry_cooldown_seconds_per_market", "label": "Re-entry cooldown seconds per market", "type": "number", "default": 5.0, "min": 0},
                {"key": "min_oracle_move_pct", "label": "Minimum oracle move (%)", "type": "number", "default": 0.15, "min": 0},
                {"key": "debug_decision_payload", "label": "Build skipped decision debug payload", "type": "bool", "default": False},
                {"key": "runtime_cache_ttl_seconds", "label": "Runtime cache TTL seconds", "type": "number", "default": 600.0, "min": 1},
                {"key": "consecutive_loss_pause_minutes", "label": "Consecutive-loss pause minutes", "type": "number", "default": 15.0, "min": 1},
                {"key": "consecutive_loss_pause_enabled", "label": "Enable consecutive-loss pause", "type": "bool", "default": True},
    ...
    SystemOpportunityStrategySeed(
        ...
        config_schema={
            "param_fields": [
                ...
                {"key": "opening_directional_buy_yes_block_elapsed_pct", "label": "BUY YES minimum elapsed ratio", "type": "number", "default": 0.10, "min": 0, "max": 1},
                {"key": "min_edge_percent", "label": "Min Edge (%)", "type": "number", "default": 1.5, "min": 0, "max": 100},
                {"key": "min_confidence", "label": "Min Confidence", "type": "number", "default": 0.45, "min": 0, "max": 1},
                {"key": "min_execution_adjusted_edge_percent", "label": "Min fee-adjusted edge (%)", "type": "number", "default": 0.5, "min": 0, "max": 100},
                {"key": "min_oracle_move_pct", "label": "Min oracle move (%)", "type": "number", "default": 0.15, "min": 0, "max": 100},
                {"key": "kelly_fraction", "label": "Kelly fraction cap", "type": "number", "default": 0.25, "min": 0, "max": 1},
                {"key": "debug_decision_payload", "label": "Build skipped decision debug payload", "type": "bool", "default": False},
                {"key": "runtime_cache_ttl_seconds", "label": "Runtime cache TTL seconds", "type": "number", "default": 600.0, "min": 1},
                {"key": "consecutive_loss_pause_minutes", "label": "Consecutive-loss pause minutes", "type": "number", "default": 15.0, "min": 1},
                {"key": "consecutive_loss_pause_enabled", "label": "Enable consecutive-loss pause", "type": "bool", "default": True},
                {"key": "directional_min_diff_pct", "label": "Directional minimum oracle difference (%)", "type": "number", "default": 0.15, "min": 0},
                {"key": "directional_early_phase_minutes", "label": "Directional early phase minutes left", "type": "number", "default": 10.0, "min": 0},
                {"key": "directional_mid_phase_minutes", "label": "Directional mid phase minutes left", "type": "number", "default": 5.0, "min": 0},
                {"key": "directional_early_min_edge", "label": "Directional early min edge (%)", "type": "number", "default": 0.08, "min": 0},
                {"key": "directional_mid_min_edge", "label": "Directional mid min edge (%)", "type": "number", "default": 0.05, "min": 0},
                {"key": "directional_late_min_edge", "label": "Directional late min edge (%)", "type": "number", "default": 0.03, "min": 0},
                {"key": "directional_early_score_mult", "label": "Directional early score multiplier", "type": "number", "default": 1.0, "min": 0},
                {"key": "directional_mid_score_mult", "label": "Directional mid score multiplier", "type": "number", "default": 1.5, "min": 0},
                {"key": "directional_late_score_mult", "label": "Directional late score multiplier", "type": "number", "default": 2.0, "min": 0},
                {"key": "directional_edge_score_scale", "label": "Directional edge score scale", "type": "number", "default": 500.0, "min": 0},
                {"key": "directional_max_score", "label": "Directional maximum score", "type": "number", "default": 80.0, "min": 0},
                {"key": "directional_late_phase_bonus", "label": "Directional late phase score bonus", "type": "number", "default": 20.0, "min": 0},
                {"key": "directional_oracle_prob_min", "label": "Directional probability floor", "type": "number", "default": 0.03, "min": 0, "max": 1},
                {"key": "directional_oracle_prob_max", "label": "Directional probability ceiling", "type": "number", "default": 0.97, "min": 0, "max": 1},
                {"key": "directional_base_scale", "label": "Directional initial sigmoid scale", "type": "number", "default": 0.50, "min": 0.001},
                {"key": "directional_min_scale", "label": "Directional minimum sigmoid scale", "type": "number", "default": 0.08, "min": 0.001},
                {"key": "direction_guardrail_enabled", "label": "Direction Guardrail Enabled", "type": "boolean"},
                {
                    "key": "direction_guardrail_prob_floor",
                    "label": "Direction Guardrail Prob Floor",
    ...
    SystemOpportunityStrategySeed(
        ...
        config_schema={
            "param_fields": [
                ...
                {"key": "min_edge_percent", "label": "Min Edge (%)", "type": "number", "default": 0.0, "min": 0, "max": 100},
                {"key": "min_confidence", "label": "Min Confidence", "type": "number", "default": 0.45, "min": 0, "max": 1},
                {"key": "convergence_min_seconds_left", "label": "Convergence minimum seconds left", "type": "number", "default": 5.0, "min": 0},
                {"key": "convergence_max_seconds_left", "label": "Convergence maximum seconds left", "type": "number", "default": 45.0, "min": 0},
                {"key": "convergence_min_oracle_diff_pct", "label": "Convergence minimum oracle difference (%)", "type": "number", "default": 0.30, "min": 0},
                {"key": "convergence_base_score", "label": "Convergence base score", "type": "number", "default": 20.0, "min": 0},
                {"key": "convergence_max_score", "label": "Convergence maximum score", "type": "number", "default": 85.0, "min": 0},
                {"key": "convergence_min_price", "label": "Convergence minimum favored price", "type": "number", "default": 0.85, "min": 0, "max": 1},
                {"key": "convergence_max_entry_price", "label": "Convergence maximum entry price", "type": "number", "default": 0.95, "min": 0, "max": 1},
                {"key": "convergence_base_scale", "label": "Convergence initial sigmoid scale", "type": "number", "default": 0.50, "min": 0.001},
                {"key": "convergence_min_scale", "label": "Convergence minimum sigmoid scale", "type": "number", "default": 0.08, "min": 0.001},
                {"key": "convergence_prob_min", "label": "Convergence probability floor", "type": "number", "default": 0.03, "min": 0, "max": 1},
                {"key": "convergence_prob_max", "label": "Convergence probability ceiling", "type": "number", "default": 0.97, "min": 0, "max": 1},
                {"key": "exit_on_oracle_flip", "label": "Exit on oracle direction flip", "type": "bool", "default": True},
                {"key": "kelly_fraction", "label": "Kelly fraction cap", "type": "number", "default": 0.25, "min": 0, "max": 1},
                {"key": "min_execution_adjusted_edge_percent", "label": "Minimum fee-adjusted edge (%)", "type": "number", "default": 0.0, "min": 0},
                {"key": "debug_decision_payload", "label": "Build skipped decision debug payload", "type": "bool", "default": False},
                {"key": "runtime_cache_ttl_seconds", "label": "Runtime cache TTL seconds", "type": "number", "default": 600.0, "min": 1},
                {"key": "consecutive_loss_pause_minutes", "label": "Consecutive-loss pause minutes", "type": "number", "default": 15.0, "min": 1},
                {"key": "consecutive_loss_pause_enabled", "label": "Enable consecutive-loss pause", "type": "bool", "default": True},
